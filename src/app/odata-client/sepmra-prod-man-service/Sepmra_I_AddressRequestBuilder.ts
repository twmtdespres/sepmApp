 ...
 */
export class Sepmra_I_AddressRequestBuilder extends RequestBuilder<Sepmra_I_Address> {
  /**
  ...
  getByKey(addressUuid: string): GetByKeyRequestBuilderV2<Sepmra_I_Address> {
    return new GetByKeyRequestBuilderV2(Sepmra_I_Address, { AddressUUID: addressUuid });
  }
  ...
  getAll(): GetAllRequestBuilderV2<Sepmra_I_Address> {
    return new GetAllRequestBuilderV2(Sepmra_I_Address);
  }
}
