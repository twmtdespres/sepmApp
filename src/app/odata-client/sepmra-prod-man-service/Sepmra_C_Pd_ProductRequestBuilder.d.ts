 ...
 */
export declare class Sepmra_C_Pd_ProductRequestBuilder extends RequestBuilder<Sepmra_C_Pd_Product> {
    /**
...
//# sourceMappingURL=Sepmra_C_Pd_ProductRequestBuilder.d.ts.map